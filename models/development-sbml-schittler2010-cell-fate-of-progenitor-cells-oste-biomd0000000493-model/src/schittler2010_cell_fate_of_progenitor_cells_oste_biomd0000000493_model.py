...
"""Auto-generated SBML BioModule wrapper for Schittler2010 - Cell fate of progenitor cells, osteoblasts or chondrocytes.

Source: biomodels_ebi:BIOMD0000000493
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000493
"""
...
class SbmlSchittler2010CellFateOfProgenitorCellsOsteoblastsOr(biosim.BioModule):
    """BioModule wrapper for SBML model: Schittler2010 - Cell fate of progenitor cells, osteoblasts or chondrocytes."""

    def __init__(self, model_path: str = "data/BIOMD0000000493.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Schittler2010CellFateOfProgenitorCellsOsteBiomd0000000493Model = SbmlSchittler2010CellFateOfProgenitorCellsOsteoblastsOr
