...
"""Auto-generated SBML BioModule wrapper for Calzone2007_CellCycle.

Source: biomodels_ebi:BIOMD0000000144
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000144
"""
...
class SbmlCalzone2007Cellcycle(biosim.BioModule):
    """BioModule wrapper for SBML model: Calzone2007_CellCycle."""

    def __init__(self, model_path: str = "data/BIOMD0000000144.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Calzone2007CellcycleBiomd0000000144Model = SbmlCalzone2007Cellcycle
