...
"""Auto-generated SBML BioModule wrapper for Gall&Pin2022 - ODE model of the intestinal epithelium.

Source: biomodels_ebi:MODEL2212120003
Original: https://www.ebi.ac.uk/biomodels/MODEL2212120003
"""
...
class SbmlGallPin2022OdeModelOfTheIntestinalEpithelium(biosim.BioModule):
    """BioModule wrapper for SBML model: Gall&Pin2022 - ODE model of the intestinal epithelium."""

    def __init__(self, model_path: str = "data/MODEL2212120003.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Gallandpin2022OdeModelOfTheIntestinalEpithModel2212120003Model = SbmlGallPin2022OdeModelOfTheIntestinalEpithelium
