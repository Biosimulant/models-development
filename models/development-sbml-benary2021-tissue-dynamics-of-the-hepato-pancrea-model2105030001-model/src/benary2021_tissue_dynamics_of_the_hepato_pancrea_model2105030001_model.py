...
"""Auto-generated SBML BioModule wrapper for Benary2021 - tissue dynamics of the hepato-pancreato-biliary organ system.

Source: biomodels_ebi:MODEL2105030001
Original: https://www.ebi.ac.uk/biomodels/MODEL2105030001
"""
...
class SbmlBenary2021TissueDynamicsOfTheHepatoPancreatoBiliary(biosim.BioModule):
    """BioModule wrapper for SBML model: Benary2021 - tissue dynamics of the hepato-pancreato-biliary organ system."""

    def __init__(self, model_path: str = "data/MODEL2105030001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Benary2021TissueDynamicsOfTheHepatoPancreaModel2105030001Model = SbmlBenary2021TissueDynamicsOfTheHepatoPancreatoBiliary
