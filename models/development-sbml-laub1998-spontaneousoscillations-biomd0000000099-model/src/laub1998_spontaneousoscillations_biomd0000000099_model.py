...
"""Auto-generated SBML BioModule wrapper for Laub1998_SpontaneousOscillations.

Source: biomodels_ebi:BIOMD0000000099
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000099
"""
...
class SbmlLaub1998Spontaneousoscillations(biosim.BioModule):
    """BioModule wrapper for SBML model: Laub1998_SpontaneousOscillations."""

    def __init__(self, model_path: str = "data/BIOMD0000000099.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Laub1998SpontaneousoscillationsBiomd0000000099Model = SbmlLaub1998Spontaneousoscillations
