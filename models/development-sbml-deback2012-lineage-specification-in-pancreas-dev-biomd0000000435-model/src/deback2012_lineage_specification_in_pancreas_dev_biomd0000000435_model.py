...
"""Auto-generated SBML BioModule wrapper for deBack2012 - Lineage Specification in Pancreas Development.

Source: biomodels_ebi:BIOMD0000000435
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000435
"""
...
class SbmlDeback2012LineageSpecificationInPancreasDevelopment(biosim.BioModule):
    """BioModule wrapper for SBML model: deBack2012 - Lineage Specification in Pancreas Development."""

    def __init__(self, model_path: str = "data/BIOMD0000000435.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Deback2012LineageSpecificationInPancreasDevBiomd0000000435Model = SbmlDeback2012LineageSpecificationInPancreasDevelopment
