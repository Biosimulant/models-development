...
"""Auto-generated SBML BioModule wrapper for Gall2023 - Agent-based model of the intestinal epithelium.

Source: biomodels_ebi:MODEL2212120002
Original: https://www.ebi.ac.uk/biomodels/MODEL2212120002
"""
...
class SbmlGall2023AgentBasedModelOfTheIntestinalEpithelium(biosim.BioModule):
    """BioModule wrapper for SBML model: Gall2023 - Agent-based model of the intestinal epithelium."""

    def __init__(self, model_path: str = "data/MODEL2212120002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Gall2023AgentBasedModelOfTheIntestinalEpiModel2212120002Model = SbmlGall2023AgentBasedModelOfTheIntestinalEpithelium
