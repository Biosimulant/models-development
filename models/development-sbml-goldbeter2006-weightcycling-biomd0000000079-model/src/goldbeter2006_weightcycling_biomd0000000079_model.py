...
"""Auto-generated SBML BioModule wrapper for Goldbeter2006_weightCycling.

Source: biomodels_ebi:BIOMD0000000079
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000079
"""
...
class SbmlGoldbeter2006Weightcycling(biosim.BioModule):
    """BioModule wrapper for SBML model: Goldbeter2006_weightCycling."""

    def __init__(self, model_path: str = "data/BIOMD0000000079.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Goldbeter2006WeightcyclingBiomd0000000079Model = SbmlGoldbeter2006Weightcycling
