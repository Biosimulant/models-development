...
"""Auto-generated SBML BioModule wrapper for Muraro2011_Cytokinin-Auxin_CrossRegulation.

Source: biomodels_ebi:BIOMD0000000416
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000416
"""
...
class SbmlMuraro2011CytokininAuxinCrossregulation(biosim.BioModule):
    """BioModule wrapper for SBML model: Muraro2011_Cytokinin-Auxin_CrossRegulation."""

    def __init__(self, model_path: str = "data/BIOMD0000000416.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Muraro2011CytokininAuxinCrossregulationBiomd0000000416Model = SbmlMuraro2011CytokininAuxinCrossregulation
