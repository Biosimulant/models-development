...
"""Auto-generated SBML BioModule wrapper for Chavez2009 - a core regulatory network of OCT4 in human embryonic stem cells.

Source: biomodels_ebi:MODEL1305010000
Original: https://www.ebi.ac.uk/biomodels/MODEL1305010000
"""
...
class SbmlChavez2009ACoreRegulatoryNetworkOfOct4InHuman(biosim.BioModule):
    """BioModule wrapper for SBML model: Chavez2009 - a core regulatory network of OCT4 in human embryonic stem cells."""

    def __init__(self, model_path: str = "data/MODEL1305010000.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Chavez2009ACoreRegulatoryNetworkOfOct4InModel1305010000Model = SbmlChavez2009ACoreRegulatoryNetworkOfOct4InHuman
