...
"""Auto-generated SBML BioModule wrapper for Intosalmi2015 - Th17 core network model.

Source: biomodels_ebi:BIOMD0000001004
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000001004
"""
...
class SbmlIntosalmi2015Th17CoreNetworkModel(biosim.BioModule):
    """BioModule wrapper for SBML model: Intosalmi2015 - Th17 core network model."""

    def __init__(self, model_path: str = "data/BIOMD0000001004.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Intosalmi2015Th17CoreNetworkModelBiomd0000001004Model = SbmlIntosalmi2015Th17CoreNetworkModel
