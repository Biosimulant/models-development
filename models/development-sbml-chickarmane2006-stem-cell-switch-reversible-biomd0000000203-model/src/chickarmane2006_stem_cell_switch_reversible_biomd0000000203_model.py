...
"""Auto-generated SBML BioModule wrapper for Chickarmane2006 - Stem cell switch reversible.

Source: biomodels_ebi:BIOMD0000000203
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000203
"""
...
class SbmlChickarmane2006StemCellSwitchReversible(biosim.BioModule):
    """BioModule wrapper for SBML model: Chickarmane2006 - Stem cell switch reversible."""

    def __init__(self, model_path: str = "data/BIOMD0000000203.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Chickarmane2006StemCellSwitchReversibleBiomd0000000203Model = SbmlChickarmane2006StemCellSwitchReversible
