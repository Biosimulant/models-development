...
"""Auto-generated SBML BioModule wrapper for Li2024 - 3D growing domain finite element model for simulation BMP patterning formation in early zebrafish embryo.

Source: biomodels_ebi:MODEL2402280002
Original: https://www.ebi.ac.uk/biomodels/MODEL2402280002
"""
...
class SbmlLi20243dGrowingDomainFiniteElementModelFor(biosim.BioModule):
    """BioModule wrapper for SBML model: Li2024 - 3D growing domain finite element model for simulation BMP patterning formation in early zebrafish embryo."""

    def __init__(self, model_path: str = "data/MODEL2402280002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Li20243dGrowingDomainFiniteElementModelFoModel2402280002Model = SbmlLi20243dGrowingDomainFiniteElementModelFor
