...
"""Auto-generated SBML BioModule wrapper for Chickarmane2006 - Stem cell switch irreversible.

Source: biomodels_ebi:BIOMD0000000204
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000204
"""
...
class SbmlChickarmane2006StemCellSwitchIrreversible(biosim.BioModule):
    """BioModule wrapper for SBML model: Chickarmane2006 - Stem cell switch irreversible."""

    def __init__(self, model_path: str = "data/BIOMD0000000204.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Chickarmane2006StemCellSwitchIrreversibleBiomd0000000204Model = SbmlChickarmane2006StemCellSwitchIrreversible
