...
"""Auto-generated SBML BioModule wrapper for Roblitz2013 - Menstrual Cycle following GnRH analogue administration.

Source: biomodels_ebi:BIOMD0000000494
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000494
"""
...
class SbmlRoblitz2013MenstrualCycleFollowingGnrhAnalogue(biosim.BioModule):
    """BioModule wrapper for SBML model: Roblitz2013 - Menstrual Cycle following GnRH analogue administration."""

    def __init__(self, model_path: str = "data/BIOMD0000000494.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Roblitz2013MenstrualCycleFollowingGnrhAnaloBiomd0000000494Model = SbmlRoblitz2013MenstrualCycleFollowingGnrhAnalogue
