...
"""Auto-generated SBML BioModule wrapper for Leber2016 - Expanded model of Tfh-Tfr differentiation - Helicobacter pylori infection.

Source: biomodels_ebi:BIOMD0000000625
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000625
"""
...
class SbmlLeber2016ExpandedModelOfTfhTfrDifferentiation(biosim.BioModule):
    """BioModule wrapper for SBML model: Leber2016 - Expanded model of Tfh-Tfr differentiation - Helicobacter pylori infection."""

    def __init__(self, model_path: str = "data/BIOMD0000000625.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Leber2016ExpandedModelOfTfhTfrDifferentiatBiomd0000000625Model = SbmlLeber2016ExpandedModelOfTfhTfrDifferentiation
