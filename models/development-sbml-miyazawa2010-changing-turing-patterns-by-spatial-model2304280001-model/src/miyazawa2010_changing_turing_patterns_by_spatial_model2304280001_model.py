...
"""Auto-generated SBML BioModule wrapper for Miyazawa2010 - changing turing patterns by spatial parameter sweep.

Source: biomodels_ebi:MODEL2304280001
Original: https://www.ebi.ac.uk/biomodels/MODEL2304280001
"""
...
class SbmlMiyazawa2010ChangingTuringPatternsBySpatialParameter(biosim.BioModule):
    """BioModule wrapper for SBML model: Miyazawa2010 - changing turing patterns by spatial parameter sweep."""

    def __init__(self, model_path: str = "data/MODEL2304280001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Miyazawa2010ChangingTuringPatternsBySpatialModel2304280001Model = SbmlMiyazawa2010ChangingTuringPatternsBySpatialParameter
