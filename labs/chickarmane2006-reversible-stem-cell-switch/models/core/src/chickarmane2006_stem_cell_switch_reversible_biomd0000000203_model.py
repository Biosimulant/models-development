...
"""Tellurium-backed SBML BioModule for Chickarmane2006 reversible stem-cell switch SBML model."""
...
class Chickarmane2006StemCellSwitchReversibleBiomd0000000203Model(TelluriumSBMLBioModule):
    """Faithful wrapper around the bundled BIOMD0000000203 SBML source."""

    _SBML_ID = 'BIOMD0000000203'
    _TITLE = 'Chickarmane2006 reversible stem-cell switch SBML model'
    ...
    def __init__(self, model_path: str = "data/BIOMD0000000203.xml", integration_step: float = 0.1) -> None:
